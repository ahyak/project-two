GravatarImageTag.configure do |config|
  config.default_image           = 'https://s.gravatar.com/avatar/a9cda406854cc6d0885305bee6fd52b3?s=80'   # Set this to use your own default gravatar image rather then serving up Gravatar's default image [ 'http://example.com/images/default_gravitar.jpg', :identicon, :monsterid, :wavatar, 404 ].
